...
Page({
    data: {
        ...
        imfor: '点击下方图片开始游戏',
        result: '/images/delight.png',
        imagerandom: '/images/robot.png',
        imageuser: '/images/headimg.jpg',
    },
    choose: function (e) {
    ...
    start: function () {
        if (this.data.result != '/images/delight.png')
            return;
